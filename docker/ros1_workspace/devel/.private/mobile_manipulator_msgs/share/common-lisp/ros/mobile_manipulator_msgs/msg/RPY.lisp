...
(cl:defmethod cl:initialize-instance :after ((m <RPY>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RPY)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mobile_manipulator_msgs-msg:<RPY> is deprecated: use mobile_manipulator_msgs-msg:RPY instead.")))

(cl:ensure-generic-function 'roll-val :lambda-list '(m))
(cl:defmethod roll-val ((m <RPY>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mobile_manipulator_msgs-msg:roll-val is deprecated.  Use mobile_manipulator_msgs-msg:roll instead.")
  (roll m))

(cl:ensure-generic-function 'pitch-val :lambda-list '(m))
(cl:defmethod pitch-val ((m <RPY>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mobile_manipulator_msgs-msg:pitch-val is deprecated.  Use mobile_manipulator_msgs-msg:pitch instead.")
  (pitch m))

(cl:ensure-generic-function 'yaw-val :lambda-list '(m))
(cl:defmethod yaw-val ((m <RPY>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mobile_manipulator_msgs-msg:yaw-val is deprecated.  Use mobile_manipulator_msgs-msg:yaw instead.")
  (yaw m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<RPY>)))
  ...
  (cl:format cl:nil "# Orientation of a reference frame~%~%# Fixed-axis roll, in radians~%float32 roll~%~%# Fixed-axis pitch, in radians~%float32 pitch~%~%# Fixed-axis yaw, in radians~%float32 yaw~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'RPY)))
  "Returns full string definition for message of type 'RPY"
  (cl:format cl:nil "# Orientation of a reference frame~%~%# Fixed-axis roll, in radians~%float32 roll~%~%# Fixed-axis pitch, in radians~%float32 pitch~%~%# Fixed-axis yaw, in radians~%float32 yaw~%~%"))
